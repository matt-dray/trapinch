...
The package uses version 2 of [the PokéAPI API]().
...
You can get meta-information about the last request and response with and  `httr2::last_response()`.

```{r}
trapinch::get_move_battle_style("attack")
```
